...
export default function SignUp() {
  ...
  async function validadeCep() {
    try {
      const { data } = await Api.post('/address/validate-cep', {
        cep
      })
      setCity(data.city)
  ...
  return (
    <div className="w-full items-center align-center justify-center flex rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="m-4 w-full border dark:border-strokedark xl:w-1/2 xl:border-l-2">
        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
          <span className="mb-1.5 block font-medium">Comece gratuitamente</span>
          <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
            Cadastre-se ao Smilify
          </h2>
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  onChange={(i) => setCnpj(i.target.value)}
                  type="text"
                  placeholder="Informe o CNPJ da clínica"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  onChange={(i) => setCep(i.target.value)}
                  type="text"
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Informe o número do estabelicimento"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  onChange={(i) => setCountry(i.target.value)}
                  type="text"
                  placeholder="Informe o País do estabelecimento"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Informe o telefone do estabelecimento"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  onChange={(i) => setPass1(i.target.value)}
                  type="password"
                  placeholder="Senha"
                  className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  onChange={(i) => setPass2(i.target.value)}
                  type="password"
